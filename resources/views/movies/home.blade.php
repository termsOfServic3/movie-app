...
<div class="popular-movies py-24">
    <h2 class="uppercase tracking-wider text-orange-500 text-lg font-semibold px-6 ml-44">Popular Movies</h2>
<main class="py-6">
...
<div class="now-playing-movies py-24">
    <h2 class="uppercase tracking-wider text-orange-500 text-lg font-semibold px-6 ml-44">Playing now</h2>
    <main class="py-6">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @foreach ($playing as $play)
                    <x-playing-card :play="$play"/>
                @endforeach
            </div>
        </div>
</div>
